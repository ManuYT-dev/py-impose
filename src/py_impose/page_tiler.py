class PageTiler:
    ...
    def __init__(self, target_size: paper_types.PageSize, inner_spacing: float = None,
        ...
        self.inner_spacing = inner_spacing or paper_types.PageSize.mm_to_points(2)
        self.outer_margin = outer_margin or paper_types.PageSize.mm_to_points(2)
        self.line_thickness = line_thickness or paper_types.PageSize.mm_to_points(1)
